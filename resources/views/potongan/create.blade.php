    ...
    <div class="container">
      <div class="card">
         <div class="card-header bg-white d-flex align-items-center justify-content-between">
            <h4 class="card-title text-capitalize">form tambah data</h4>
         ...
         <div class="card-body">
            ...
            <div class="form-group my-3">
               ...
               <input type="text" name="jenisPotongan" id="jenisPotongan" class="form-control @error('jenisPotongan')
                   is-invalid
               @enderror" value="{{ old('jenisPotongan') }}" placeholder="Masukan jenis potongan">
               @error('jenisPotongan')
            ...
            <div class="form-group my-3">
               ...
               <input type="text" name="nilaiPotongan" id="nilaiPotongan" class="form-control @error('nilaiPotongan')
                   is-invalid
               @enderror" value="{{ old('nilaiPotongan') }}" placeholder="Masukan nilai potongan">
               @error('nilaiPotongan')
                   <div class="invalid-feedback">{{ $message }}</div>
               @enderror
            </div>
